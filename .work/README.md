...
- [x] Plan 文档就绪（Plan1–Plan6）
- [x] 框架采用决策留痕（`change/2026-04-23-adopt-langgraph-harness.md`）
- [ ] Plan 1 实施：基础层（项目骨架 / 配置 / 接口 / DI / 框架就绪）
- [ ] Plan 2 实施：安全层（命令执行 / SSH / 输入校验）
- [ ] Plan 3 实施：LLM Provider + LangChain 集成
- [ ] Plan 4 实施：LangGraph Agent 编排 + 核心服务层
- [ ] Plan 5 实施：Intelligence 模块（Tool 化）
- [ ] Plan 6 实施：UI + Harness + CI + 发布
