...
- **245 unit tests + 12 HITL scenarios**, 88%+ coverage, `mypy --strict`, `bandit` clean
...
| Tests | 0 | 245 unit + 12 HITL scenarios + integration suite |
...
```bash
make test       # pytest with 80% fail-under, currently 88%+
make lint       # ruff
