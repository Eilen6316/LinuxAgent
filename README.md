...
- **249 unit tests + 12 HITL scenarios**, 89%+ coverage, `mypy --strict`, `bandit` clean
...
| Tests | 0 | 249 unit + 12 HITL scenarios + integration suite |
...
```bash
make test       # pytest with 80% fail-under, currently 89%+
make lint       # ruff
