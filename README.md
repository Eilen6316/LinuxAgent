...
- **266 default unit tests + 1 optional provider test + 12 HITL scenarios**, 90%+ coverage, `mypy --strict`, `bandit` clean
...
| Tests | 0 | 266 default unit + 1 optional provider + 12 HITL scenarios + 8 integration smoke tests |
