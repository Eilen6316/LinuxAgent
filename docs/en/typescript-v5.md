...
the policy fixture corpus and audit verifier tamper detection, then prints
placeholder summaries for harness and red-team parity while those suites are
expanded. Keep Python gates
