...
| `@linuxagent/agent-runtime` | Session permissions, approval defaults, tool gate, executor-backed command tool, prompt loader, and planner validation |
...
| `pi-agent-core` runtime wrapper | Next |
