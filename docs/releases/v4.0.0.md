...
- Eight built-in YAML runbooks for common operations diagnostics.
- Multi-step runbook orchestration with policy checks on each step.
...
Current baseline: 272 unit tests, 4 optional Anthropic compatibility tests,
12 harness scenarios, 8 integration smoke tests, and 90.65% unit-test coverage.
