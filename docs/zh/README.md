<div align="center">
  ...
  <p>
    ...
    <a href="#开发"><img src="https://img.shields.io/badge/coverage-86.78%25-brightgreen?style=flat-square" alt="Coverage"></a>
...
| 可测试性 | 当前文档基线为 677 个单元测试通过、覆盖率 86.78%；另有 HITL YAML 场景、10 个集成冒烟测试、红队用例和可选 Anthropic 兼容验证 |
...
| 覆盖率 | 0 | **86.78%**（`--cov-fail-under=80` 门禁；以当前 CI / 本地 `make test` 输出为准） |
