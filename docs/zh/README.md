<div align="center">
  ...
  <p>
    ...
    <a href="#开发"><img src="https://img.shields.io/badge/coverage-87.06%25-brightgreen?style=flat-square" alt="Coverage"></a>
...
| 可测试性 | 当前文档基线为 396 个单元测试通过、覆盖率 87.06%；另有 12 个 HITL YAML 场景、8 个集成冒烟测试和可选 Anthropic 兼容验证 |
...
| 维度 | 旧实现 | 当前 `v4` |
|---|---|---|
| 单元测试 | 0 | **当前文档基线：396 通过；安装 Anthropic extra 后可运行兼容验证** |
| 覆盖率 | 0 | **87.06%**（`--cov-fail-under=80` 门禁；以当前 CI / 本地 `make test` 输出为准） |
