<div align="center">
  ...
  <p>
    ...
    <a href="#开发"><img src="https://img.shields.io/badge/coverage-88.66%25-brightgreen?style=flat-square" alt="Coverage"></a>
...
| 可测试性 | 默认 367 个单元测试 + 可选 Anthropic 兼容覆盖 + 12 个 HITL YAML 场景 + 8 个集成冒烟测试，覆盖率 88%+ |
...
| 维度 | 旧实现 | 当前 `v4` |
|---|---|---|
| 单元测试 | 0 | **默认 367 通过；安装 Anthropic extra 后覆盖 Anthropic 兼容路径** |
| 覆盖率 | 0 | **88.66%**（`--cov-fail-under=80` 门禁） |
