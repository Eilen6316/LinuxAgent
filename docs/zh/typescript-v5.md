...
| `@linuxagent/agent-runtime` | 会话权限、审批默认值、tool gate、连接 executor 的 command tool、prompt loader |
...
| planner validation 和 fake model tests | 下一步 |
| `pi-agent-core` runtime wrapper | 尚未落地 |
| 实验 TUI/CLI | 尚未落地 |
